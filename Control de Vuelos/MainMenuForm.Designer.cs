namespace Control_de_Vuelos {
	partial class MainMenuForm {
		...
		private void InitializeComponent() {
			...
			// btAerolineas
			// 
			this.btAerolineas.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
			...
			// btReportes
			// 
			this.btReportes.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
			...
			// btMantenimiento
			// 
			this.btMantenimiento.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
			...
			// btVuelos
			// 
			this.btVuelos.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
